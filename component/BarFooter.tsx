...
const BarFooter = ({ViewUpdate}:any) => {
    //navegacion
        ...
        return <View>
            <ModalComponent id_modal={'modal_siniestro_buscar'} visible={modalVisible} onClose={closeModal}>
                <View style={{ position: 'absolute', top: 0, bottom: 0, left: 0, right: 0 }}>
                    <IconComponent nameIcon='fondoCard' alto='100%' ancho='100%' data={{ color_1: "#BBEEAA", color_2: "#334477" }}></IconComponent>
                </View>
    ...
    return <View style={styles.footer}>
        <TouchableOpacity key={"btn_footer_ppl"} style={styles.item_footer} onPress={() => action('Ppl')}>
            <IconComponent nameIcon="iconPolizaFot" alto="35px" ancho="35px" data={{ color_1: "gray" }}></IconComponent>
        ...
        <TouchableOpacity key={"btn_footer_siniestro"} style={styles.item_footer} onPress={() => openModalSiniestro()}>
            <IconComponent nameIcon="iconSiniestroFot" alto="35px" ancho="35px" data={{ color_1: "gray" }}></IconComponent>
            <Text style={styles.text_footer}>Siniestro</Text>
        </TouchableOpacity>
        <View style={styles.item_footer}></View>
        <View style={{ display: "flex", justifyContent: "center", borderRadius: 50, position: 'absolute', height: "120%", top: "-20%", left: "38%", right: "38%", alignItems: "center", backgroundColor: "gray" }}>
            <TouchableOpacity key={"btn_footer_call"} style={{ display: "flex", justifyContent: "center",width:'100%',height:'100%', borderRadius: 50, alignItems: "center", backgroundColor: "brown" }} onPress={() => fetchData()}>
                <IconComponent nameIcon="call" alto="50px" ancho="50px" data={{ color_1: "white" }}></IconComponent>
                <Text style={{ ...styles.text_footer, color: "white" }}>Panico</Text>
            </TouchableOpacity>
        </View>
        <TouchableOpacity key={"btn_footer_mapa"} style={styles.item_footer} onPress={() => actionJSON('Mapa',{TYPE:'getSucursales'})}>
            <IconComponent nameIcon="iconOficinaFot" alto="35px" ancho="35px" data={{ color_1: "gray" }}></IconComponent>
        ...
        <TouchableOpacity key={"btn_footer_contacto"} style={styles.item_footer} onPress={() => openModalUser()}>
            <IconComponent nameIcon="iconContactoFot" alto="35px" ancho="35px" data={{ color_1: "gray" }}></IconComponent>
